...
set_property -dict { PACKAGE_PIN AB8 IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports { sdcard_cd }];
...
# ddram:0.a
set_property LOC P1 [get_ports {ddram_a[0]}]
...
# ddram:0.dq
set_property LOC G2 [get_ports {ddram_dq[9]}]
...
# ddram:0.cke
set_property LOC N4 [get_ports {ddram_cke}]
set_property SLEW FAST [get_ports {ddram_cke}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_cke}]

# ddram:0.odt
set_property LOC L3 [get_ports {ddram_odt}]
