...
reg           wishbone_interface_reader_pending_status = 1'd0;
...
reg           wishbone_interface_reader_status_status = 1'd0;
...
reg           wishbone_interface_writer_pending_status = 1'd0;
...
reg           wishbone_interface_writer_status_status = 1'd0;
        ...
        1'd1: begin
            ...
            if (core_tx_crc_sink_last) begin
                if (core_tx_crc_sink_payload_last_be) begin
                    core_tx_crc_source_payload_data <= slice_proxy[7:0];
                end
...
assign csrbank0_reset0_w = maccore_maccore_reset_storage[1:0];
assign csrbank0_scratch0_w = maccore_maccore_scratch_storage[31:0];
assign csrbank0_bus_errors_w = maccore_maccore_bus_errors_status[31:0];
...
assign csrbank1_sram_writer_errors_r = interface1_bank_bus_dat_w[31:0];
always @(*) begin
...
assign csrbank1_rx_datapath_preamble_errors_r = interface1_bank_bus_dat_w[31:0];
always @(*) begin
...
assign csrbank1_rx_datapath_crc_errors_r = interface1_bank_bus_dat_w[31:0];
always @(*) begin
...
assign csrbank1_sram_writer_length_w = wishbone_interface_writer_length_status[10:0];
assign wishbone_interface_writer_length_we = csrbank1_sram_writer_length_we;
assign csrbank1_sram_writer_errors_w = wishbone_interface_writer_errors_status[31:0];
assign wishbone_interface_writer_errors_we = csrbank1_sram_writer_errors_we;
always @(*) begin
    wishbone_interface_writer_status_status <= 1'd0;
    wishbone_interface_writer_status_status <= wishbone_interface_writer_available0;
end
...
always @(*) begin
    wishbone_interface_writer_pending_status <= 1'd0;
    wishbone_interface_writer_pending_status <= wishbone_interface_writer_available1;
end
...
assign csrbank1_sram_reader_level_w = wishbone_interface_reader_level_status[1:0];
...
assign csrbank1_sram_reader_length0_w = wishbone_interface_reader_length_storage[10:0];
always @(*) begin
    wishbone_interface_reader_status_status <= 1'd0;
    wishbone_interface_reader_status_status <= wishbone_interface_reader_event00;
end
...
always @(*) begin
    wishbone_interface_reader_pending_status <= 1'd0;
    wishbone_interface_reader_pending_status <= wishbone_interface_reader_event01;
end
...
assign csrbank1_rx_datapath_preamble_errors_w = core_preamble_errors_status[31:0];
assign core_preamble_errors_we = csrbank1_rx_datapath_preamble_errors_we;
assign csrbank1_rx_datapath_crc_errors_w = core_crc_errors_status[31:0];
...
assign csrbank2_mdio_w0_w = maccore_ethphy__w_storage[2:0];
...
assign slice_proxy = {core_tx_crc_value, core_tx_crc_sink_payload_data[7:0]};
always @(*) begin
    array_muxed0 <= 30'd0;
    case (grant)
        default: begin
...
always @(posedge sys_clk) begin
    ...
    if (csrbank0_reset0_re) begin
        maccore_maccore_reset_storage[1:0] <= csrbank0_reset0_r;
    end
    maccore_maccore_reset_re <= csrbank0_reset0_re;
    if (csrbank0_scratch0_re) begin
        maccore_maccore_scratch_storage[31:0] <= csrbank0_scratch0_r;
    end
    ...
    if (csrbank1_sram_reader_length0_re) begin
        wishbone_interface_reader_length_storage[10:0] <= csrbank1_sram_reader_length0_r;
    end
    ...
    if (csrbank2_mdio_w0_re) begin
        maccore_ethphy__w_storage[2:0] <= csrbank2_mdio_w0_r;
    end
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2026-02-06 21:53:53.
//------------------------------------------------------------------------------
